...
import com.apptolast.greenhouse.admin.presentation.viewmodel.PeriodFormMode
...
/**
 * Tab content for Periods management.
 */
@Composable
fun SettingsPeriodsTab(
    periods: List<Period>,
    showDialog: Boolean,
    ...
    Column(
        ...
        Column(
            ...
            Row(
                ...
                Text(
                    text = stringResource(Res.string.settings_tab_periods),
            ...
            if (periods.isEmpty()) {
                ...
                PeriodsTable(periods = periods, onEdit = onEditClicked, onDelete = onDeleteClicked)
            }
        }
    }
}
            ...
            periods.forEach { period ->
                Row(
                    ...
                    Row(
                        ...
                        IconButton(onClick = { onDelete(period) }) {
                            Icon(
...
private fun PeriodFormDialog(
    ...
    AlertDialog(
        ...
        title = {
            Text(
                text = stringResource(if (isEditMode) Res.string.dialog_edit_period else Res.string.dialog_create_period),
                style = MaterialTheme.typography.titleLarge,
                fontWeight = FontWeight.SemiBold
            )
        },
